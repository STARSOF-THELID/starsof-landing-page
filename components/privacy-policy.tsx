          ...
          <div className="mx-auto max-w-3xl pb-12 text-left text-gray-800 md:pb-16">
            ...
            <div className="text-base font-normal">
              <p>
                ...
                and users of the StarsOfAR desktop app and websites (collectively,
                “StarsOfAR”, “App” or “Apps”), which are offered by StarsOfAR Inc.
            ...
            <div className="space-y-4 text-base font-normal">
              <p>
                If you are a customer of StarsOfAR, this Privacy Policy does not
            ...
            <div className="space-y-4 text-base font-normal">
              <p>
                ...
                development. The amount and type of information that StarsOfAR
                ...
                creating an account on the App. In each case, StarsOfAR collects
                such personal information only insofar as is necessary or
                appropriate to fulfill the purpose of your interaction with or
                your request to StarsOfAR. We will not disclose your personal
                information other than as described in this Privacy Policy.
              </p>
              <p>
                Like most website operators, StarsOfAR automatically collects (i)
            ...
            <h2 className="mb-7 mt-14 text-3xl font-medium text-gray-900">
              Information StarsOfAR does not collect
            </h2>
            <div className="space-y-4 text-base font-normal">
              <p>
                StarsOfAR does not intentionally collect sensitive or special
              ...
              <p>
                StarsOfAR does not knowingly collect information from or direct any
            ...
            <div className="thin-bullets space-y-4 text-base font-normal">
              ...
              <p>
                ...
                StarsOfAR About Your Privacy&apos; section of this Privacy Policy.
              </p>
            </div>

            <h2 className="mb-7 mt-14 text-3xl font-medium text-gray-900">
              How StarsOfAR uses and protects your personal information
            </h2>
            <div className="thin-bullets space-y-4 text-base font-normal">
              <p>
              ...
              <p>
                StarsOfAR may share your personal information with the
                third-parties listed below for the purposes that are described
                in this Privacy Policy or otherwise with your consent.
              </p>
              <p>
                StarsOfAR only shares your personal information with those of its
                ...
                StarsOfAR&apos;s behalf or to provide services available on the
                App, and (ii) that have agreed not to disclose it to others.
              </p>
              <p>
                StarsOfAR may disclose your personal information to professional
              ...
              <p>
                StarsOfAR may sell, transfer or otherwise share some or all of our
              ...
              <p>
                ...
                StarsOfAR engages a number of service providers or partners to
              ...
              <p>
                ...
                other than to perform the services as instructed by StarsOfAR.
              </p>
              <p>
              ...
              <p>
                StarsOfAR takes measures reasonably necessary to protect your
            ...
            <div className="space-y-4 text-base font-normal">
              ...
              <p>
                ...
                &apos;Contacting StarsOfAR About Your Privacy&apos; section of this
                Privacy Policy.
              </p>
            </div>

            <h2 className="mb-7 mt-14 text-3xl font-medium text-gray-900">
              StarsOfAR communications with you
            </h2>
            <div className="space-y-4 text-base font-normal">
              <p>
                If you are a registered user of the Apps and have supplied your
                email address, StarsOfAR may occasionally send you an email to tell
                you about security, system information, new features, solicit
                your feedback, or just keep you up to date with what&apos;s
                going on with StarsOfAR and our products. We primarily use our blog
            ...
            <div className="thin-bullets space-y-4 text-base font-normal">
              ...
              <p>
                ...
                given below in the &apos;Contacting StarsOfAR About Your
            ...
            <div className="space-y-4 text-base font-normal">
              ...
              <p>
                StarsOfAR will retain your information for as long as your account
                ...
                the details in the &apos;Contacting StarsOfAR About Your
                Privacy&apos; section of this Privacy Policy.
              </p>
              <p>
            ...
            <h2 className="mb-7 mt-14 text-3xl font-medium text-gray-900">
              Contacting StarsOfAR About Your Privacy
            </h2>
            <div className="space-y-4 text-base font-normal">
              <p>
                The relevant data controller for any personal information
                processed in connection with our Apps is StarsOfAR Inc.
              </p>
              <p>
            ...
            <div className="space-y-4 text-base font-normal">
              <p>
                StarsOfAR may change its privacy policy from time to time, and in
                StarsOfAR&apos;s sole discretion.
              </p>
              <p>
