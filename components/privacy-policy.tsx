          ...
          <div className="mx-auto max-w-3xl pb-12 text-left text-gray-800 md:pb-16">
            ...
            <div className="text-base font-normal">
              <p>
                ...
                and users of the StarsOfAR desktop app and websites
                (collectively, “StarsOfAR”, “App” or “Apps”), which are offered
                by StarsOfAR Inc. and/or any of its affiliates (“Anysphere” or
            ...
            <div className="space-y-4 text-base font-normal">
              ...
              <p>
                Like most website operators, StarsOfAR automatically collects
            ...
            <div className="space-y-4 text-base font-normal">
              ...
              <p>
                StarsOfAR does not knowingly collect information from or direct
            ...
            <div className="thin-bullets space-y-4 text-base font-normal">
              ...
              <p>
                ...
                StarsOfAR About Your Privacy&apos; section of this Privacy
                Policy.
              </p>
            </div>
            ...
            <div className="thin-bullets space-y-4 text-base font-normal">
              ...
              <p>
                StarsOfAR may sell, transfer or otherwise share some or all of
            ...
            <div className="space-y-4 text-base font-normal">
              ...
              <p>
                ...
                &apos;Contacting StarsOfAR About Your Privacy&apos; section of
                this Privacy Policy.
              </p>
            </div>
            ...
            <div className="space-y-4 text-base font-normal">
              <p>
                ...
                email address, StarsOfAR may occasionally send you an email to
                tell you about security, system information, new features,
                solicit your feedback, or just keep you up to date with
                what&apos;s going on with StarsOfAR and our products. We
            ...
            <div className="space-y-4 text-base font-normal">
              ...
              <p>
                StarsOfAR will retain your information for as long as your
            ...
            <div className="space-y-4 text-base font-normal">
              <p>
                StarsOfAR may change its privacy policy from time to time, and
                in StarsOfAR&apos;s sole discretion.
              </p>
              <p>
